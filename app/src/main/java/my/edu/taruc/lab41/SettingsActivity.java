...
public class SettingsActivity extends AppCompatActivity {
    private static final String PREF_FILE = "my.edu.taruc.lab41";
    ...
    protected void onResume() {
        ...
        gender = sharedPreferences.getInt("user-gender", -1);
    ...
    protected void onPause() {
        ...
        //Apply all changes to the Shared Preference
        editor.apply();
    }
}
